...
<CardGroup cols={2}>
  <Card
    ...
    icon="link"
    href="/solutions/agent-to-agent-monetization"
  >
  ...
  <Card
    ...
    icon="plug"
    href="/solutions/mcp-point-of-sales"
  >
  ...
  <Card
    ...
    icon="lock"
    href="/solutions/access-control-monetization-static-resources"
  >
  ...
  <Card
    ...
    icon="chart-line"
    href="/solutions/ai-agents-observability"
  >
  ...
  <Card
    ...
    icon="credit-card"
    href="/products/payments/overview"
  >
...
Learn more in our [Integration guides](/integrate/quickstart/5-minute-setup).

---

<Note>
  **Ready to ship?** Start with the [5-minute
  setup](/integrate/quickstart/5-minute-setup).
</Note>
