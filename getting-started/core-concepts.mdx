...
Not sure which a plan uses? See [Which payment type does this plan need?](/development-guide/order-plans#which-payment-type-does-this-plan-need) to detect it in code before you pay.
