...
- **Legal Assistant**: A tiered model with a "Silver" plan (100 xDAI for 500 credits, 5-25 credits per query) and a "Gold" plan (1 ETH for unlimited access for a year).
