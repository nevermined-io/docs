...
<Steps>
  ...
  <Step title="Pick how you'll pay">
    ...
    A plan is paid either by stablecoin **or** by card — never both. To know which (and, for cards, which provider), resolve it from the plan before you choose: see [Which payment type does this plan need?](/getting-started/core-concepts#fiat-vs-crypto-what-each-plan-needs).
  </Step>
