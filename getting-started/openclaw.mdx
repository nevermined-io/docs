...
<CardGroup cols={2}>
  <Card
    ...
    icon="rocket"
    href="/api-reference/openclaw-plugin/getting-started"
  >
  ...
  <Card
    title="Setup"
    icon="gear"
    href="/api-reference/openclaw-plugin/setup"
  >
  ...
  <Card
    title="Commands"
    icon="terminal"
    href="/api-reference/openclaw-plugin/commands"
  >
  ...
  <Card
    ...
    icon="book-open"
    href="/api-reference/openclaw-plugin/guide"
  >
