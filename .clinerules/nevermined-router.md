...
- Only `BCK.ROUTER.0006` (500, summary read), `0007` (429, too many concurrent), `0020` (5xx/429) and `0028` (503,
  quote) are **retryable** — on the paying path, `0007` and `0020`. Everything else is a decision — retrying
