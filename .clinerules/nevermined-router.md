...
- `BCK.ROUTER.0025` (502) — the upstream reply was too large to deliver after a paid request. Payment may have gone through; reconcile with `list_payments`. Do not retry with a fresh `requestId`.
