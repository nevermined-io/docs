...
<CardGroup cols={3}>
  ...
  <Card title="Delegations" icon="shield-check" href="/docs/products/nvm-pay/mandates">
...
<Steps>
  <Step title="Enroll a card">
    Add a Visa, Stripe, or Braintree card at [pay.nevermined.app](https://pay.nevermined.app). Card data is tokenized in the browser by the provider's PCI-compliant capture (VGS Collect for Visa and Stripe, Braintree Drop-in for Braintree). NVM Pay never stores raw card numbers.
  </Step>
