...
<CardGroup cols={2}>
  <Card title="Payment Plans" icon="file-invoice-dollar" href="/docs/products/nvm-pay/payment-plans">
    Learn about different plan types
  </Card>
  <Card title="Payment Methods" icon="wallet" href="/docs/products/nvm-pay/payment-methods">
    Crypto and fiat payment options
  </Card>
  <Card title="Credits Engine" icon="gauge" href="/docs/products/nvm-pay/credits-engine">
    Understanding the credits system
  </Card>
  <Card title="Revenue Management" icon="chart-line" href="/docs/products/nvm-pay/revenue-management">
