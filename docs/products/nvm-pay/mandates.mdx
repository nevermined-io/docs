...
{/*
  URL note: this file lives at `/docs/products/nvm-pay/mandates` despite the
...
| `apiKeyId` | Optional NVM API key link for [automatic selection](/docs/products/nvm-pay/mandate-selection) |
...
After enrolling a card, create a delegation from the [Nevermined Pay dashboard](https://pay.nevermined.app):
...
You can optionally link a delegation to a specific NVM API key. This tells NVM Pay "when this API key is used, charge this delegation."
...
<Card title="Delegation Selection" icon="route" href="/docs/products/nvm-pay/mandate-selection">
