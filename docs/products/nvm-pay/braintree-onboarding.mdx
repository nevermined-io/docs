...
description: "Connect your Braintree merchant account to Nevermined Pay so buyers can pay your plans by card and receive funds in your supported currencies."
icon: "store"
---
...
If you only need to *pay* for a Braintree-priced plan as a buyer, see [Card Enrollment → Braintree](/docs/products/nvm-pay/card-enrollment) instead.
...
| Plan creation rejected with `BCK.BRAINTREE.0008` | The chosen currency has no child merchant account on your gateway | Add the merchant account in Braintree, then disconnect and reconnect Nevermined Pay. |
...
<CardGroup cols={2}>
  <Card title="Card Enrollment (Buyer-Side)" icon="id-card" href="/docs/products/nvm-pay/card-enrollment">
