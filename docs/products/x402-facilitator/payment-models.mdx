...
description: "Configure credits-based, time-based, and dynamic pricing for your AI agents"
icon: "calculator"
---

The x402 Facilitator supports multiple payment models to match your business needs. Configure how subscribers pay for access to your AI agents.
