...
<Note>
  For the complete technical specification, see the [x402 Smart Accounts
  Extension Spec](/docs/specs/x402-smart-accounts).
</Note>
...
<Card
  title="How It Works"
  icon="gears"
  href="/docs/products/x402-facilitator/how-it-works"
>
