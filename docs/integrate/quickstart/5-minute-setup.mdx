...
<Steps>
  <Step title="Get Your API Key">
    Follow the [Get Your API Key](/docs/getting-started/get-your-api-key) guide to create your API key, then set it as an environment variable:
...
<Tip>
Want subscribers to pay with a regular credit card instead of stablecoins? [NVM Pay](/docs/products/nvm-pay/overview) lets subscribers enroll a Visa or Stripe card and create spending mandates that agents charge directly.
</Tip>
