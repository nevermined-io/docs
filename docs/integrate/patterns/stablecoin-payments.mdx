...
description: "Accept USDC, EURC, USDT, or any ERC-20 token on-chain with the lowest fees and full transparency."
icon: "coins"
---

Accept USDC, EURC, USDT, or any ERC-20 token directly on-chain. Stablecoin payments are Nevermined's native payment method, purpose-built for crypto users and autonomous agent-to-agent commerce.
