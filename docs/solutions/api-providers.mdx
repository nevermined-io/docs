...
If you're on a framework without a middleware (Hono, Fastify, Flask, Django, ...) or building in another language, call the facilitator directly — either via the SDK or as raw HTTP. Same wire behaviour — just more code.
