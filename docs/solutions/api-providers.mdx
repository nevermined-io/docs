...
<Steps>
  ...
  <Step title="Settle">
    Call `payments.facilitator.settlePermissions(...)`. The card is charged and you get paid. (On credits-bundle plans, credits are also minted and burned at this step; on PAYG, there's no credit movement.)
  </Step>
</Steps>
