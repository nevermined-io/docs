...
<Steps>
  <Step title="Create a plan">
    On the [Nevermined App](https://nevermined.app/), choose **pay-as-you-go** pricing (single price per purchase), set your price, and get a plan ID. Or do it programmatically with your NVM API key. See [Manage Plans](/docs/products/nevermined-app/manage-plans).
  </Step>
...
<Tabs>
  ...
  <Tab title="Python (FastAPI)">
    ...
    async def purchase_key(request: Request, response: Response):
