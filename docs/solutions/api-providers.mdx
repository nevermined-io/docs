...
Three Nevermined account tiers, picked at sign-up:

| Plan | Cost | What's included |
|---|---|---|
| **Starter** | Free | Publish up to 20 agents and 10 plans on a single-seat account. Unlimited customers. No org features (no widgets, no auto-generated agent docs, no analytics). |
| **Premium Organization** ⭐ **Recommended** | **\$250 / month** | Up to 100 agents and 50 plans, 5 invitable seats, widget card capture, auto-generated `llms.txt` / `agentic-instructions.md`, webhooks, analytics, activity feed. |
| **Enterprise Organization** | **\$500 / month** | Premium + unlimited agents, plans, and seats, plus the [customer CRM](/docs/solutions/organizations/customers) and the realtime activity stream. |
