...
<CardGroup cols={1}>
  <Card
    ...
    icon="key"
    href="/docs/specs/x402-smart-accounts"
  >
    Extends x402 with ERC-4337 smart accounts, session keys, and programmable
    smart contract settlement
  </Card>
  <Card
    title="x402 Visa VIC Extension"
    icon="credit-card"
    href="/docs/specs/x402-visa-vic"
  >
    Extends x402 with Visa Intelligence Commerce (VIC) and Visa Token Service
    (VTS) for fiat payments
  </Card>
</CardGroup>
