...
<CardGroup cols={1}>
  ...
  <Card title="x402 Visa VIC Extension" icon="credit-card" href="/docs/specs/x402-visa-vic">
    Extends x402 with Visa Intelligence Commerce (VIC) and Visa Token Service (VTS) for fiat payments
  </Card>
</CardGroup>
