...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `id` | `string` | Yes | Operation identifier. Common values: `"order"`, `"burn"`, `"burn"`. |
...
The `maxAmount` specifies the actual credits to burn (can be less than or equal to the verified amount).
...
| Field | Type | Description |
|-------|------|-------------|
| `creditsBurned` | `string` | Number of credits burned. |
