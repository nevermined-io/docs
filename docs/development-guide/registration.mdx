...
<Tabs>
  ...
  <Tab title="Python">
    ...
    from payments_py.plans import get_fiat_price_config, get_eurc_price_config, get_fixed_credits_config

    # EUR fiat plan (priced in euro cents)
    eur_price_config = get_fiat_price_config(2900, builder_address, Currency.EUR)
    eur_plan = payments.plans.register_credits_plan(
    ...
    eurc_plan = payments.plans.register_credits_plan(
