...
### Open Code and Cursor

1. Open Settings and search for **Model Context Protocol** or **MCP Servers**.
2. Add a new remote server with the URL `https://docs.nevermined.app/mcp`.
3. Enable the connector in the in-editor chat so the assistant can cite docs while coding.

### Continue (VS Code / JetBrains)

1. Open Continue settings (`continue.json` or UI) and locate **MCP / Tools**.
2. Add an MCP entry named `nevermined-docs` pointing to `https://docs.nevermined.app/mcp`.
3. Reload Continue; the tool will stream doc context into completions and inline chat.
