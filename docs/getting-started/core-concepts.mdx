...
<CardGroup cols={2}>
  <Card title="Payment Method" icon="credit-card">
    [**Cards**](/docs/products/nvm-pay/overview) (Visa, Stripe, or Braintree via NVM Pay) or [**Crypto**](/docs/integrate/patterns/stablecoin-payments) (USDC, EURC on-chain).
  </Card>
...
<CardGroup cols={2}>
  <Card title="Cards" icon="credit-card" href="/docs/products/nvm-pay/overview">
    Pay with real Visa, Stripe, or Braintree cards via [NVM Pay](/docs/products/nvm-pay/overview). Agents charge against spending delegations with lifetime limits, usage caps, and (for Visa) per-delegation WebAuthn/passkey device binding. No crypto wallet needed.
  </Card>
