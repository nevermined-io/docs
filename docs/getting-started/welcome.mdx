...
<CardGroup cols={2}>
  ...
  <Card
    title="Agent Fiat Payments"
    icon="credit-card"
    href="/docs/products/nvm-pay/overview"
  >
    Let agents pay with real cards. Subscribers enroll a Visa or Stripe card and agents charge autonomously within spending limits.
  </Card>
</CardGroup>
