...
- **Subscribers** pay for access. They can purchase a plan via Stripe checkout or stablecoins, or enroll a card via [card delegation](/docs/products/payments/overview) for autonomous agent-to-agent payments.
