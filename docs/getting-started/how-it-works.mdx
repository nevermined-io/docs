...
Card delegation via NVM Pay is what makes agent-to-agent fiat payments possible. Instead of a human clicking through checkout each time, the subscriber enrolls a Visa, Stripe, or Braintree card, sets spending limits, and the agent charges it directly within those bounds.
