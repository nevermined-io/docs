...
<CardGroup cols={2}>
  <Card title="Strands Integration" icon="robot" href="/docs/integrate/add-to-your-agent/strands">
    Protect Strands agent tools with x402 payments
  </Card>
  <Card title="FastAPI Integration" icon="bolt" href="/docs/integrate/add-to-your-agent/fastapi">
    Add x402 middleware to FastAPI apps
  </Card>
