...
<Note>
  Give your agent the **`nevermined-payments` skill** (in the [docs repo](https://github.com/nevermined-io/docs/tree/main/skills/nevermined-payments)) or point it at your organization's `agentic-instructions.md` (e.g. `https://api.sandbox.nevermined.app/api/v1/organizations/{orgId}/agentic-instructions.md`). Either one teaches the agent every endpoint it needs — the prompts on these pages assume it has one of them.
</Note>
