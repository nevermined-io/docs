...
![Weather Agent](https://examples.nevermined.app/mcp.png)

Steps:

1. The user opens the [Weather App](https://examples.nevermined.app/mcp-agent/) and requests a forecast for a specific location.
