...
For a full walkthrough of these three files — what each one contains, how agents consume them, and worked examples — see [Agentic Integration](/solutions/organizations/agentic-integration).
