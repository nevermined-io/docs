...
Share a wallet with a [group](/solutions/organizations/groups-and-budgets) to make it that group's funding source. Combined with a **budget**, this lets a team spend from the shared treasury up to a ceiling you control — and you can un-share a wallet from a group whenever you need to cut it off.
...
<Steps>
  ...
  <Step title="Cap it with a budget">Set a [budget](/solutions/organizations/groups-and-budgets#budgets) so the group draws down only as fast as you allow.</Step>
</Steps>
...
Wallet creation, balances, funding groups, and withdrawals are all available on the Organizations REST API with your **organization's admin** [Nevermined API key](/solutions/organizations/workspaces-and-members) — so an autonomous agent can top up a team or sweep a treasury without a human in the dashboard.
