...
| **Card-delegation lifecycle** | `delegation.created`, `delegation.expired`, `delegation.exhausted`, `delegation.revoked` |
...
<CardGroup cols={1}>
  <Card title="Read the activity feed from the SDK" icon="code" href="/integrate/patterns/organizations#read-the-organization-activity-feed">
