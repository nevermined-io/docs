...
<CardGroup cols={2}>
  ...
  <Card title="Top customers" icon="ranking-star">
    Your highest-spending customers, ranked, with a link straight into the [Customers](/solutions/organizations/customers) CRM.
  </Card>
...
<Tip>
  Want these numbers in your own BI tooling or a scheduled report? The organization activity feed is available programmatically from the [Payments SDK](/integrate/patterns/organizations), so you can build your own monitoring and roll-ups on top of the same events.
</Tip>
