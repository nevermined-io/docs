...
_Webhooks are available on Premium and Enterprise through the API today; the in-dashboard **Webhooks** tab is rolling out — see [Activity & Events](/solutions/organizations/activity-and-events#webhooks)._
...
<CardGroup cols={2}>
  ...
  <Card title="Groups & Budgets" icon="layer-group" href="/solutions/organizations/groups-and-budgets">
    Bundle members into teams, cap their spend with budgets, and share payment methods.
  </Card>
  <Card title="Organization Wallets" icon="wallet" href="/solutions/organizations/wallets">
    A custodial USDC/EURC treasury that funds your groups.
  </Card>
  ...
  <Card title="White-label Onboarding" icon="user-plus" href="/solutions/organizations/white-label-onboarding">
    Provision your own customers programmatically — under your brand, no seat, with a scoped key to pay for your agents on their behalf.
  </Card>
  ...
  <Card title="Embed Widgets" icon="puzzle-piece" href="/integrations/organization-widgets">
    Render Nevermined checkout, card, and delegation flows on your own domain.
  </Card>
  <Card title="Platform Partners" icon="money-bill-transfer" href="/integrations/organizations">
  ...
  <Card title="Programmatic & Agentic Access" icon="robot" href="/solutions/organizations/programmatic-access">
    Drive the whole organization from code, and let agents discover and pay for your agents.
  </Card>
