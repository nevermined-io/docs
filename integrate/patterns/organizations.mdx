...
<CardGroup cols={2}>
  <Card title="Organizations on Nevermined" icon="building" href="/solutions/organizations/overview">
    Concepts, tiers, and the webapp surface for organization owners.
  </Card>
  <Card title="Quickstart — TypeScript" icon="code" href="/integrate/quickstart/typescript">
    Set up the SDK and publish your first agent.
  </Card>
  <Card title="Quickstart — Python" icon="python" href="/integrate/quickstart/python">
    Set up the Python SDK and publish your first agent.
  </Card>
  <Card title="Payment Models" icon="credit-card" href="/integrate/patterns/payment-models">
