...
<Steps>
  ...
  <Step title="Credits consumed per request">
    Each API call or agent query burns credits according to the plan configuration. If the subscriber's balance runs low, the facilitator can [top up](/integrate/patterns/top-up) their credits automatically — when the wallet has sufficient balance and the delegation permits it.
  </Step>
</Steps>
...
See the [Automatic Credit Top-Ups](/integrate/patterns/top-up) guide for how it works, how to set up the delegation, crypto vs. fiat behavior, and failure handling.
...
<CardGroup cols={2}>
  ...
  <Card title="Nevermined x402" icon="handshake" href="/development-guide/nevermined-x402">
    Deep dive into the x402 protocol and smart account settlement
  </Card>

  <Card title="Payment Plans API" icon="code" href="/api-reference/typescript/payment-plans">
