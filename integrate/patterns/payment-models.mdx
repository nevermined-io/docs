...
The Payments Facilitator supports multiple payment models to match your product needs across APIs, agents/tools, and protected resources.
...
- [Nevermined x402](/development-guide/nevermined-x402)
...
<CardGroup cols={2}>
  <Card title="Register Your Agent" icon="robot" href="/integrate/quickstart/5-minute-setup">
    Set up your agent with a payment plan
  </Card>

  <Card title="Validate Requests" icon="shield-check" href="/integrate/patterns/validate-requests">
