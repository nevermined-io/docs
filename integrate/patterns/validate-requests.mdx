...
<Note>
  ...
  - [Express.js Integration](/integrate/add-to-your-agent/express)
  - [FastAPI Integration](/integrate/add-to-your-agent/fastapi)
  - [Generic HTTP Integration](/integrate/add-to-your-agent/generic-http)
</Note>
...
<CardGroup cols={2}>
  <Card title="Charge Credits" icon="coins" href="/integrate/patterns/charge-credits">
    Deduct credits for requests
  </Card>

  <Card title="Subscription Access" icon="calendar" href="/integrate/patterns/subscription-access">
