...
<Tabs>
  <Tab title="TypeScript">
    ...
    // scheme is auto-detected from plan metadata when omitted
...
<Tabs>
  <Tab title="Express.js">
    ...
    ```
    See [Express.js Integration](/integrate/add-to-your-agent/express) for details.
  </Tab>
  <Tab title="FastAPI">
    ```python
    ...
    ```
    See [FastAPI Integration](/integrate/add-to-your-agent/fastapi) for details.
  </Tab>
</Tabs>
