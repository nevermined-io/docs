...
sequenceDiagram
    ...
    Client->>Agent: Call agent — no payment-signature
...
See the [Python SDK installation guide](/api-reference/python/installation) for full setup details.
...
<CardGroup cols={2}>
  ...
  <Card title="Strands Integration" icon="robot" href="/integrate/add-to-your-agent/strands">
