...
<AccordionGroup>
  ...
  <Accordion title="Requests Observability" icon="chart-line">
    Tracks & reports the usage and cost of your agent's internal services, including: - **Underlying **LLMs or other API calls, **Agent API** requests and credits consumed
  </Accordion>
