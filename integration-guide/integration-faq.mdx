...
* **Sandbox**: This is a testing environment where you can safely develop and test your integration. It makes real transactions but without any economical value.
...
a. If you are using the [Nevermined App](https://nevermined.app), you can switch environments in the [Environment](https://nevermined.app/environment) section. Just click on the "Switch Environment" button to change between "sandbox" and "live".
