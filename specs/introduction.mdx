...
<CardGroup cols={1}>
  <Card title="x402 Smart Accounts Extension" icon="key" href="/specs/x402-smart-accounts">
    Extends x402 with ERC-4337 smart accounts, session keys, and programmable smart contract settlement
  </Card>
  <Card title="x402 Card Delegation Extension" icon="credit-card" href="/specs/x402-card-delegation">
