...
<CardGroup cols={2}>
  ...
  <Card title="Enroll a card & delegate" icon="credit-card" href="/agents-guide/enroll-card">
    Grant a fresh budget when a delegation is spent or expired.
  </Card>
  <Card title="Order Plans" icon="receipt" href="/development-guide/order-plans">
