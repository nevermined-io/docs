...
<Note>
  Paying with **stablecoins** needs no card and no human enrollment — your account's ERC‑4337 wallet is ready as soon as it's funded. Use this flow only for card payments. See [Buy access](/getting-started/ai-agent-purchase) for the stablecoin path.
</Note>
...
<Steps>
  ...
  <Step title="Reuse it to pay">
    Pass the stored `delegationId` whenever you buy — see [Buy access](/getting-started/ai-agent-purchase). One delegation covers many purchases until its budget is spent or it expires.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Check credits" icon="wallet" href="/agents-guide/check-credits">
