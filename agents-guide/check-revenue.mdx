...
<Steps>
  ...
  <Step title="Per-request usage (optional)">
    For token-level usage and cost tracking, the SDK integrates with Helicone via `payments.observability`. See [AI Agents Observability](/solutions/ai-agents-observability) for the full picture.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="AI Agents Observability" icon="chart-line" href="/solutions/ai-agents-observability">
