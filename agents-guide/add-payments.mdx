...
<Note>
  Swap the framework line for your stack — guides exist for [Express](/integrate/add-to-your-agent/express), [FastAPI](/integrate/add-to-your-agent/fastapi), [Strands](/integrate/add-to-your-agent/strands), and [generic HTTP](/integrate/add-to-your-agent/generic-http).
</Note>
...
<Steps>
  <Step title="Register an agent and a plan">
    ...
    See [Register a plan & agent](/agents-guide/register-plan-and-agent) for the full options (fiat pricing, time-based and pay-as-you-go plans).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Register a plan & agent" icon="store" href="/agents-guide/register-plan-and-agent">
