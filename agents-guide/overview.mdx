...
<CardGroup cols={2}>
  <Card title="1. Buy access" icon="cart-shopping" href="/getting-started/ai-agent-purchase">
    Purchase plan credits autonomously via x402 — with stablecoins or a card.
  </Card>
  <Card title="2. Enroll a card & delegate" icon="credit-card" href="/agents-guide/enroll-card">
    Add a card and grant the agent a capped, time‑boxed spending budget.
  </Card>
  <Card title="3. Get an API key" icon="key" href="/agents-guide/get-api-key">
    Obtain a Nevermined API key with one click from a human, captured automatically.
  </Card>
  <Card title="4. Add payments to your agent" icon="plug" href="/agents-guide/add-payments">
    Make your own agent charge callers per request behind an x402 paywall.
  </Card>
  <Card title="5. Register a plan & agent" icon="store" href="/agents-guide/register-plan-and-agent">
    Publish an AI agent and a priced payment plan so others can buy it.
  </Card>
  <Card title="6. Check credits (buyer)" icon="wallet" href="/agents-guide/check-credits">
    Report remaining credits and delegation budgets across your purchases.
  </Card>
  <Card title="7. Check revenue (seller)" icon="chart-line" href="/agents-guide/check-revenue">
...
<CardGroup cols={2}>
  <Card title="Using the Catalog from a harness" icon="terminal" href="/products/catalog/from-a-harness">
    Point your agent at external pay‑per‑call services in the Catalog — the code‑free flow, principles, and links.
  </Card>
  <Card title="AI Agents: Buy Access" icon="robot" href="/getting-started/ai-agent-purchase">
