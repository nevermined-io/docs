---
title: "How the Payments Facilitator Works"
...
<Note>
**Recommended:** For Express.js applications, use the [`paymentMiddleware`](/integrate/add-to-your-agent/express) which handles all of this automatically with one line of code.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="x402 Integration" icon="plug" href="/development-guide/nevermined-x402">
    Complete integration guide with code examples
  </Card>

  <Card title="Technical Spec" icon="file-code" href="/specs/x402-smart-accounts">
