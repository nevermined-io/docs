...
The Facilitator sits in the [x402 payment flow](/development-guide/nevermined-x402) — when a server receives a payment token, it delegates verification and settlement to the Facilitator rather than handling it directly.
