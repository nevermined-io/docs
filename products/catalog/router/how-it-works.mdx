...
- **x402** settles the fee as a **second settleable authorization** on the same rail, submitted alongside the merchant's. Its key on the ledger row is [`feeNonce`](/products/catalog/router/ledger#auditing-the-fee-leg).
