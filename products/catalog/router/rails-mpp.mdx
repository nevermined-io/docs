...
Like x402, MPP `charge` is a **pull**: the merchant takes the amount from your own wallet on the Tempo chain in question. Fund the address on your Delegation (`providerPaymentMethodId`) with the token for that chain before you call.
