...
Set your environment once. The Catalog is **Live-only for payment** — every listed service settles on mainnet, and the sandbox Router funds testnets only, so point at the live host:
