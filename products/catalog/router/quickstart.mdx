...
<Note>
Driving this from an agent harness? [Using the Catalog from a harness](/products/catalog/from-a-harness) is the code-free companion to this page — the same flow as principles, plus the safety habits (idempotency, soft stops, "you only pay on success") an autonomous buyer should follow.
</Note>
