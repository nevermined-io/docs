...
Base URL is the live environment host: `https://api.live.nevermined.app`. The Catalog is **Live-only** — listed services settle on mainnet, so the sandbox host surfaces no payable listings.
