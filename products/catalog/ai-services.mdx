...
- **Hidden while payments don't go through.** If a listing's paid calls over the last 7 days all went undelivered, it is hidden from discovery. That takes at least 3 undelivered calls from at least 2 different buyers, and none settled. An undelivered call is one that failed, or one where your endpoint collected the payment and returned no result. One settled call brings the listing back. If there are no new calls, it comes back automatically after 3 days.
- **No uptime claim without a settled call.** If a listing has at least 3 paid calls from at least 2 buyers in the last 30 days and none of them settled, it stays listed but shows no "operational" status, uptime or last-healthy time until a call settles.
