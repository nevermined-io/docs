...
<CardGroup cols={3}>
  ...
  <Card title="MCP" icon="plug" href="/products/catalog/mcp/overview">
    Wire the Commerce MCP into any MCP-capable host so the Catalog and Router become tools your agent can call directly.
  </Card>
