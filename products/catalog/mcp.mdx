...
<Warning>
Paying against **live** moves real funds to a real merchant. There's a **sandbox** (`https://mcp.sandbox.nevermined.app/mcp`) that runs the same tools with no real money — wire things up there first, and keep your first Delegation cap small either way.
</Warning>
