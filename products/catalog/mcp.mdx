...
<Warning>
**The config above points at live**, where `pay_service` moves real funds to a real merchant. The Catalog is **Live-only** — the sandbox Router funds testnets only, so no listed service is payable there. Rehearse with the cheapest sub-cent service and keep your first Delegation cap small.
</Warning>
