...
Create a **current (v2)** key from the [Nevermined app](https://nevermined.app). Discovery tools don't need it, but `pay_service` and the ledger tools do. Older keys are rejected by the Router — see [the Router quickstart](/products/catalog/router/quickstart#1-get-an-api-key) for how to tell which you have.
