...
<CardGroup cols={2}>
  <Card title="Register Agents" icon="robot" href="/products/nevermined-app/register-agents">
    Step-by-step guide to registering your first agent
  </Card>

  <Card title="Manage Plans" icon="credit-card" href="/products/nevermined-app/manage-plans">
    Create and configure payment plans
  </Card>

  <Card title="Payment Libraries" icon="code" href="/api-reference/introduction">
