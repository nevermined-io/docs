...
`providerPaymentMethodId` is the wallet address to fund. Send it the payment asset **on the network you intend to pay on** — see [the x402 rail](/products/router/rails-x402) and [the MPP rail](/products/router/rails-mpp) for which networks and assets each supports.
