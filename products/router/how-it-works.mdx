...
<Warning>
**On x402 an underfunded wallet costs you budget.** With no pre-check the Router signs and reserves your cap, the merchant's transfer then fails on-chain, and the reserved cap is **not** given back. Fund before you call; don't rely on being stopped.
</Warning>
