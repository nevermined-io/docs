...
- **Download**: [nevermined.mcp.json](/download/nevermined-mcp-config) - Ready-to-use configuration for Cursor, Continue, Claude Desktop, and other MCP clients
...
**Nevermined Documentation MCP Server URL:** `https://nevermined.ai/docs/mcp`
...
<Tabs>
  <Tab title="Claude Code">
    ```bash
    claude mcp add --transport http nevermined-docs https://nevermined.ai/docs/mcp
    ```
  </Tab>
  <Tab title="Cursor">
    ```bash
...
`https://nevermined.ai/docs/mcp`.

<Tip>
**Quick Start**: Download the [nevermined.mcp.json](/download/nevermined-mcp-config) configuration file and use it as a reference for your IDE's MCP setup. The file contains the complete configuration needed for most MCP-compatible tools.
</Tip>
...
3. Enter the server URL `https://nevermined.ai/docs/mcp` and save
...
1. **Using Configuration File**:
   - Download [nevermined.mcp.json](/download/nevermined-mcp-config)
   - Copy contents to `~/.cursor/mcp.json`
   - Reload the IDE

2. **Manual GUI Setup**:
   - Open Settings → search for **MCP Servers**
   - Add remote server: `https://nevermined.ai/docs/mcp`
...
2. Add MCP server: `nevermined-docs` → `https://nevermined.ai/docs/mcp`
3. Reload Continue to activate

> If your IDE supports MCP but is not listed, add a remote MCP connector pointing to
> `https://nevermined.ai/docs/mcp` and enable it for chat/code actions. The server
...
<Tip>
**Configuration Reference**: If you prefer to edit the configuration file directly (located at `~/Library/Application Support/Claude/claude_desktop_config.json` on macOS), see our [nevermined.mcp.json](/download/nevermined-mcp-config) for the correct format.
</Tip>
...
2. Enter the server URL: `https://nevermined.ai/docs/mcp`
...
```text
I want to create an AI agent that validates user requests using Nevermined.
...
- Verify you're using the correct URL: `https://nevermined.ai/docs/mcp`
...
- Check if the MCP server is accessible at: https://nevermined.ai/docs/mcp
