...
For **MCP**, we built integration with our payments libraries. You can find [sample Python integration](https://github.com/nevermined-io/weather-mcp-demo-py) and [sample Typescript integration](https://github.com/nevermined-io/weather-mcp-demo) for how to use Nevermined to control and get paid for access to your MCP server(s).
...
- If you are using the [Nevermined App](https://nevermined.app), you can switch environments in [Settings > Environments](https://nevermined.app/environment). Just click on the "Switch Environment" button to change between "sandbox" and "live".
