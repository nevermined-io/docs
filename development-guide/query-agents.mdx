---
title: "Query Agents"
description: "Learn how users can query AI Agents after purchasing access"
icon: "magnifying-glass"
---

Once a user (or agent) purchases a Payment Plan, the user can query all the AI Agents associated to that plan.
