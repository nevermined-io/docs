...
The full list of what changed in each version is in the [API Changelog](/development-guide/api-changelog).
...
1. Read the [API Changelog](/development-guide/api-changelog) entries between your pin and the target version.
