...
Use the `withHeliconeOpenAI` method to wrap your OpenAI client with automatic logging:
...
Use the `withHeliconeLangchain` method to wrap your Langchain client with automatic logging:
