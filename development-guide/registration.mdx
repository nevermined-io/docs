...
You can register your Payment Plans and AI Agents manually or programatically:

<CardGroup cols={2}>
  <Card title="Nevermined App" icon="calculator">
    Go to the [Nevermined App](https://nevermined.app) and click on "My agents" or "My pricing plans" to register your AI Agents and Payment Plans.
  </Card>
  <Card title="Payments Libraries" icon="calendar">
    Use the Payments Libraries to programmatically register your AI Agents and Payment Plans.
  </Card>
</CardGroup>
...
<Note>
In this guide, we will focus on how to register Payment Plans and AI Agents using the Payments Libraries.
</Note>
...
## Registering a Payment Plan and AI Agent in One Step
...
<CardGroup cols={2}>
  <Card title="Test Purchasing" icon="shopping-cart" href="/development-guide/order-plans">
