...
<Note>
This guide is for organization admins. If you haven't upgraded to an organization yet, see [Platform Partners](/integrations/organizations) first.
</Note>
...
<CardGroup cols={2}>
  <Card title="White-label Onboarding" icon="user-plus" href="/solutions/organizations/white-label-onboarding">
    The programmatic counterpart: provision customers from your backend with the SDK instead of an embedded widget.
  </Card>
  <Card title="Platform Partners" icon="building" href="/integrations/organizations">
