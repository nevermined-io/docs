...
<Info>
  Platform Partners is one of the [Organizations](/solutions/organizations/overview) features. For the full picture — team workspaces, tiers, customers, analytics, and events — start with the [Organizations overview](/solutions/organizations/overview).
</Info>
...
<CardGroup cols={2}>
  <Card title="Nevermined App" icon="browser" href="/products/nevermined-app/overview">
    Manage your platform from the dashboard
  </Card>
  <Card title="Payment Patterns" icon="money-bill" href="/integrate/patterns/fiat-payments">
...
<CardGroup cols={1}>
  <Card title="Embed Nevermined Widgets" icon="puzzle-piece" href="/integrations/organization-widgets">
...
<CardGroup cols={1}>
  <Card title="Organizations & Workspaces (SDK guide)" icon="building" href="/integrate/patterns/organizations">
