...
| `BCK.ROUTER.0025` | 502 | The upstream reply was too large to deliver after a paid request. The payment outcome is indeterminate; it may have gone through. | No — reconcile with `list_payments`; do **not** retry with a fresh `requestId` |
