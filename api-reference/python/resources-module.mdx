...
For details on how subscribers access static resources using x402 access tokens, see [Request Validation](/api-reference/python/validation-module).
...
<CardGroup cols={2}>
  <Card title="Payments and Balance" icon="arrow-right" href="/api-reference/python/balance-module">
