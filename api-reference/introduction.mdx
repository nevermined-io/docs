...
<CardGroup cols={2}>
  <Card title="Register Agents" icon="brain" href="/api-reference/register-agent">
    Publish metadata and register endpoints for your AI agent
  </Card>
  <Card title="Create Plans" icon="credit-card" href="/api-reference/register-plan">
    Define fixed, expirable, or dynamic usage-based payment plans
  </Card>
  <Card title="Query Agents" icon="code" href="/api-reference/query-agent">
    Query agents with valid access and enforce credit redemption
  </Card>
  <Card title="Redeem Credits" icon="coins" href="/api-reference/redeem-credits">
